<?php get_header(); ?>
          ...
          <ul class="nav-list">
            <li class="nav-list-point">
              <a href="" class="nav-list-point-href">
                <img src="img/nav_icon_1.svg" alt="nav image" class="nav-list-point-href-image" />
                <span class="nav-list-point-href-text">О портале</span>
              </a>
            </li>
            <li class="nav-list-point" data-type="casinos">
              <a href="" class="nav-list-point-href">
                <img src="img/nav_icon_2.svg" alt="nav image" class="nav-list-point-href-image" />
                <span class="nav-list-point-href-text">Обзоры онлайн казино</span>
              </a>
            </li>
            <li class="nav-list-point">
              <a href="" class="nav-list-point-href">
                <img src="img/nav_icon_3.svg" alt="nav image" class="nav-list-point-href-image" />
                <span class="nav-list-point-href-text">Игровые автоматы</span>
              </a>
            </li>
            <li class="nav-list-point">
              <a href="" class="nav-list-point-href">
                <img src="img/nav_icon_4.svg" alt="nav image" class="nav-list-point-href-image" />
                <span class="nav-list-point-href-text">Платежные средства</span>
              </a>
            </li>
          </ul>
          <div class="nav-input-container">
            <input placeholder="поиск по сайту..." type="text" class="nav-input" />
          </div>
        </div>
      </div>
      <div class="nav-popup">
        <div class="nav-popup-content wrapper">
          <div class="nav-popup-container">
            <div class="nav-popup-lists-container">
              <p class="nav-popup-lists-text">Best Online Casinos</p>
              <div class="nav-popup-lists-content">
                <ul class="nav-popup-list">
                  <p class="nav-popup-list-main-text">Featured</p>
                  <li class="nav-popup-list-point"><a href="#" class="nav-popup-list-point-link">Casino Reviews</a></li>
                  <li class="nav-popup-list-point"><a href="#" class="nav-popup-list-point-link">Gambling Sites </a></li>
                  <li class="nav-popup-list-point"><a href="#" class="nav-popup-list-point-link">Live Dealer Casinos</a></li>
                  <li class="nav-popup-list-point"><a href="#" class="nav-popup-list-point-link">Mobile Casinos </a></li>
                  <li class="nav-popup-list-point"><a href="#" class="nav-popup-list-point-link">New Casinos Real</a></li>
                  <li class="nav-popup-list-point"><a href="#" class="nav-popup-list-point-link">Money Casinos </a></li>
                  <li class="nav-popup-list-point"><a href="#" class="nav-popup-list-point-link">Safe Casinos</a></li>
                </ul>
                <ul class="nav-popup-list">
                  <p class="nav-popup-list-main-text">by Country</p>
                  <li class="nav-popup-list-point"><a href="#" class="nav-popup-list-point-link">All Casinos by Country</a></li>
                  <li class="nav-popup-list-point"><a href="#" class="nav-popup-list-point-link">USA Casinos</a></li>
                  <li class="nav-popup-list-point"><a href="#" class="nav-popup-list-point-link">USA Casinos by State</a></li>
                </ul>
                <ul class="nav-popup-list">
                  <p class="nav-popup-list-main-text">by Deposit Method</p>
                  <li class="nav-popup-list-point"><a href="#" class="nav-popup-list-point-link">All Casino Deposit Methods </a></li>
                  <li class="nav-popup-list-point"><a href="#" class="nav-popup-list-point-link">Bitcoin Casinos </a></li>
                  <li class="nav-popup-list-point"><a href="#" class="nav-popup-list-point-link">Mastercard Casinos </a></li>
                  <li class="nav-popup-list-point"><a href="#" class="nav-popup-list-point-link">Visa Casinos</a></li>
                </ul>
              </div>
              <img src="img/footer_main_block_image_1.png" alt="nav image" class="nav-popup-lists-image" />
            </div>
            <div class="nav-popup-card">
              <img src="img/nav_popup_image_1.png" alt="nav popup image" class="nav-popup-card-image" />
              <p class="nav-popup-card-main-text" data-typeimage="on">€300 + 225 бесплатных вращений!</p>
              <p class="nav-popup-card-second-text">Нет требований по отыгрышу</p>
              <p class="nav-popup-card-second-text">100% выигрыша можно вывести</p>
              <p class="nav-popup-card-second-text">Вывод менее чем за 24 часа</p>
              <p class="nav-popup-card-main-text">1000 игр</p>
              <div class="nav-popup-card-stars-container">
                ...
                <p class="nav-popup-card-stars-number">5</p>
              </div>
              <p class="nav-popup-card-text">более 2000 оценок</p>
              <div class="nav-popup-card-buttons-container">
                <button class="nav-popup-card-button" data-type="review">review</button>
                <button class="nav-popup-card-button">Play now</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="banner-container">
          <div class="crumbs-container">
            <ul class="crumbs-list-container">
              ...
              <li class="crumbs-list-point"><p class="crumbs-list-point-link">Путь до внутренней страницы</p></li>
            </ul>
          </div>
          <div class="banner-text-container">
            <h2 class="banner-text-main">Jeux de Casino Gratuits</h2>
            <p class="banner-text-second" data-type="first">
              <strong>Vous venez de découvrir la plus grande bibliothèque de jeux de casino gratuits en ligne.</strong> Comme des milliers de joueurs de machines à sous qui utilisent
              JeuxGratuits.Casino chaque jour, vous avez maintenant un accès instantané à plus de 8000 jeux de casino gratuits en ligne que vous pouvez jouer ici-même.
            </p>
            <p class="banner-text-second">
              Nos jeux de casino gratuits peuvent être joués dans n'importe quelle partie du monde, tant que vous êtes connecté à Internet. Vous n'avez pas besoin de parier de l'argent réel, vous
              pouvez jouer à nos machines à sous gratuites en ligne 24 heures sur 24 et 7 jours sur 7 sans téléchargement requis.
            </p>
            <p class="banner-text-second">
              Et nous ajoutons de nouveaux jeux de machines à sous gratuits tous les jours. C'est pourquoi nous sommes la plus grande collection de jeux de casino gratuits en France.
            </p>
          </div>
        </div>
      </div>
    ...
    <section class="banner_sort">
      <div class="banner_sort-content wrapper">
        <div class="banner_sort-container">
          <img src="img/index/ind_banner_1.png" alt="index banner image" class="banner_sort-image" />
          <img src="img/index/ind_banner_1_mobile.png" alt="index banner image" class="banner_sort-image-mobile" />
            ...
            <div class="banner_sort-select-container">
              ...
              <div class="banner_sort-selects">
                <div class="banner_sort-select-content">
                  ...
                  <img src="img/arrow_vector_top.svg" alt="banner sort image" class="banner_sort-select-image-prev" />
                  <img src="img/arrow_vector_bottom.svg" alt="banner sort image" class="banner_sort-select-image-next" />
                </div>
                <div class="banner_sort-select-content">
                  <select name="select" class="banner_sort-select">
        ...
        <div class="game_cards-container">
          <div class="game_cards-point">
            <div class="game_cards-point-image-container">
              <img src="img/cards/card_image_1.png" alt="cards image" class="game_cards-point-image" />
          ...
          <div class="game_cards-point">
            <div class="game_cards-point-image-container">
              <img src="img/cards/card_image_2.png" alt="cards image" class="game_cards-point-image" />
              <div class="game_cards-point-image-button-container"><button class="game_cards-point-image-button">Play Now</button></div>
            </div>
            <div class="game_cards-point-text-container">
              <div class="game_cards-point-text-stars-container">
          ...
          <div class="game_cards-point">
            <div class="game_cards-point-image-container">
              <img src="img/cards/card_image_3.png" alt="cards image" class="game_cards-point-image" />
              <div class="game_cards-point-image-button-container"><button class="game_cards-point-image-button">Play Now</button></div>
            </div>
            <div class="game_cards-point-text-container">
              <div class="game_cards-point-text-stars-container">
          ...
          <div class="game_cards-point">
            <div class="game_cards-point-image-container">
              <img src="img/cards/card_image_4.png" alt="cards image" class="game_cards-point-image" />
              <div class="game_cards-point-image-button-container"><button class="game_cards-point-image-button">Play Now</button></div>
            </div>
            <div class="game_cards-point-text-container">
              <div class="game_cards-point-text-stars-container">
          ...
          <div class="game_cards-point">
            <div class="game_cards-point-image-container">
              <img src="img/cards/card_image_5.png" alt="cards image" class="game_cards-point-image" />
              <div class="game_cards-point-image-button-container"><button class="game_cards-point-image-button">Play Now</button></div>
            </div>
            <div class="game_cards-point-text-container">
              <div class="game_cards-point-text-stars-container">
          ...
          <div class="game_cards-point">
            <div class="game_cards-point-image-container">
              <img src="img/cards/card_image_6.png" alt="cards image" class="game_cards-point-image" />
              <div class="game_cards-point-image-button-container"><button class="game_cards-point-image-button">Play Now</button></div>
            </div>
            <div class="game_cards-point-text-container">
              <div class="game_cards-point-text-stars-container">
      ...
      <div class="comment_instruction-content wrapper">
        <div class="comment_instruction-container">
          <div class="comment_instruction-text-and-image-container">
            <img src="img/index/ind_com_inst_image_1.png" alt="instruction image bg" class="comment_instruction-bg-image" />

            <div class="comment_instruction-text-container">
              <p class="comment_instruction-main-text">Comment jouer aux jeux de casino en ligne</p>
              <p class="comment_instruction-second-text">
                Vous vous demandez comment jouer gratuitement aux jeux de casino en ligne sans télécharger de logiciel? La solution est simple: jetez un coup d'œil à l'un des jeux de machines à sous
                gratuits répertoriés sur notre site et vous pouvez y jouer dans votre navigateur.
              </p>
              <p class="comment_instruction-second-text">Nous vous guiderons à travers les étapes ici pour vous montrer à quel point il est facile de commencer:</p>
            </div>
          </div>

          <ul class="comment_instruction-list">
            <li class="comment_instruction-list-point">
              <p class="comment_instruction-list-point-main-text">Étape 1: Visitez notre lobby de jeux gratuits</p>
              <p class="comment_instruction-list-point-second-text">
                Faites défiler vers le haut notre sélection de jeux de casino gratuits et choisissez un jeu qui vous plaît. Si vous n'êtes pas sûr du jeu de machine à sous gratuit auquel vous
                souhaitez jouer, vous pouvez en trouver un grâce à notre système de filtrage. Vous pouvez trier notre sélection de machines à sous gratuites de casino par ordre alphabétique, du plus
                récent au plus ancien, ou par popularité. Vous pouvez même filtrer nos jeux par thème, dont nous avons des tonnes.
              </p>
              <p class="comment_instruction-list-point-second-text">
                Si vous recherchez certaines fonctionnalités de machine à sous ou des jeux d'un fournisseur spécifique, vous pouvez également filtrer selon ces options
              </p>
              <p class="comment_instruction-list-point-text">
                N'oubliez pas que vous pouvez cliquer sur le bouton "Charger plus de jeux" pour trouver votre machine à sous gratuite parfaite. Vous pouvez choisir parmi 7 000 machines à sous
                gratuites, sans téléchargement ni inscription requise.
              </p>
            </li>
            <li class="comment_instruction-list-point">
              <p class="comment_instruction-list-point-main-text">Étape Deux: Charger le Jeu dans Votre Navigateur Web</p>
              <p class="comment_instruction-list-point-second-text">
                Une fois que vous avez trouvé votre machine à sous en ligne gratuite et que vous avez cliqué dessus, vous serez redirigé vers le jeu dans votre navigateur web. Cliquez sur "Démarrer le
                jeu" et la machine à sous gratuite se chargera en un rien de temps. Si vous êtes débutant, nous vous conseillons de consulter l'onglet d'informations et le tableau des gains. Ils vous
                aideront à comprendre le fonctionnement de la machine à sous en ligne.
              </p>
              <p class="comment_instruction-list-point-second-text">
                Le tableau des gains vous montrera le genre de prix que vous pouvez obtenir et les symboles spéciaux que vous devriez garder à l'œil.
              </p>
              <div class="comment_instruction-list-point-yellow-container">
                <img src="img/pages_lamp_icon_1.svg" alt="list image" class="comment_instruction-list-point-yellow-image" />
                <div class="comment_instruction-list-point-yellow-text-container">
                  <p class="comment_instruction-list-point-yellow-main-text">🤔 Saviez-vous?</p>
                  <p class="comment_instruction-list-point-yellow-second-text">
                    Grâce à notre logiciel HTML5, vous pouvez profiter de nos machines à sous mobiles gratuites sur n'importe quel appareil, que ce soit un smartphone, une tablette ou un ordinateur de
                    bureau.
                  </p>
                </div>
              </div>
            ...
            <li class="comment_instruction-list-point">
              <p class="comment_instruction-list-point-main-text">Étape Trois: Commencer à Jouer Gratuitement pour le Plaisir !</p>
              <p class="comment_instruction-list-point-second-text">
                Une fois que vous êtes satisfait de votre machine à sous en ligne gratuite, appuyez sur le bouton "Spin" ! Toutes nos démos de jeux de casino sont livrées avec un généreux solde
                virtuel. Ce solde est connu sous le nom de "crédits". Vous pouvez jouer avec ces crédits de machine à sous aussi longtemps que vous le souhaitez. Vous pouvez les rafraîchir avec le
                bouton en haut à droite de la fenêtre du jeu.
              </p>
              <p class="comment_instruction-list-point-second-text">
                Les jeux gratuits fonctionnent comme des jeux en argent réel, si vous frappez une combinaison spécifique avec les symboles, vous pouvez déclencher des tours de spins gratuits et
                d'autres fonctionnalités bonus.
              </p>
              <p class="comment_instruction-list-point-text">
                <strong>Top astuce:</strong> Si vous aimez la machine à sous en ligne sur laquelle vous jouez, vous pouvez en choisir une autre dans la colonne "Quel jeu jouerez-vous ensuite?".
                Trouver des machines à sous gratuites pour s'amuser n'a jamais été aussi facile !
              </p>
            </li>
          </ul>
        </div>
      ...
      <div class="jackpot-content wrapper">
        <div class="jackpot-container">
          <div class="jackpot-image-container">
            <img src="img/jackpot.png" alt="jackpot image" class="jackpot-image" />
          </div>
      ...
      <div class="top_games-content wrapper">
        <div class="top_games-container">
          ...
          <div class="top_games-slider wrapper">
                ...
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <div class="swiper-slide-container">
                      <!-- <div class="swiper-slide-container">
              <img src="img/cards/card_image_1.png" alt="slider image" class="swiper-slide-image" />
            ...
            <div class="sw-nav">
              <button class="sw-prev"><img src="img/arrow_vector_left.svg" alt="prev image" class="sw-prev-image" /></button>
              <button class="sw-next"><img src="img/arrow_vector_right.svg" alt="next image" class="sw-next-image" /></button>
            </div>
        ...
        <div class="free_games-container">
          ...
          <div class="free_games-cards-container">
            ...
            <div class="free_games-card" data-type="yellow">
              <img src="img/index/ind_free_games_icon_2.svg" alt="" class="free_games-bg" />
    ...
    <section class="jackpot">
      <div class="jackpot-content wrapper">
        <div class="jackpot-container">
          <div class="jackpot-image-container">
            <img src="img/jackpot_2.svg" alt="jackpot image" class="jackpot-image" />
          </div>
          <div class="jackpot-text-container">
      ...
      <div class="any_devices-content wrapper">
        <div class="any_devices-container">
          <div class="any_devices-list-container">
            ...
            <img src="img/index/ind_any_devices_image_1.svg" alt="devices image" class="any_devices-list-image" />
          </div>
    ...
    <section class="faq">
      <div class="faq-content wrapper">
        <div class="faq-container">
          ...
          <img src="img/faq_image_1.svg" alt="faq image" class="faq-image" />
        </div>
      </div>
    </section>
